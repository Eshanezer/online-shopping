...
public class PageController {
	...
	public ModelAndView index() {
		...
		logger.info("Inside the page controller - INFO");
		logger.debug("Inside the page controller - DEBUG");
	 ...
	 * ModelAndView mv = new ModelAndView("page"); if(greeting==null) { greeting
	 * ="Hellow Dear"; } mv.addObject("greeting", greeting); return mv; }
	 */

	/*
	 * @RequestMapping(value = { "/test/{greeting}" }) public ModelAndView
	 * test(@PathVariable("greeting") String greeting) { ModelAndView mv = new
	 * ModelAndView("page"); mv.addObject("userClick",true);
	 * mv.addObject("title","") return mv; }
	 */
